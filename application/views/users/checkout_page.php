...
<div class="row">
	<div class="col-lg-6">
		...
		<?= form_open('checkout')?>
			...
			<p>Now we have only option cash on delivery. Online Payment facility will be added in future</p>
	...
	<div class="col-lg-6">
		...
		<?php
			...
			print "<td colspan = '2'>₹ ".$this->cart->total()."</td>";
			print "</tr>";
			...
			print "<td colspan = '2'>₹ ".$payable_total."</td>";
			print "</tr>";
