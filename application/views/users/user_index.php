...
<?php 
  ...
  <div class = "container">'.$this->session->flashdata('success').'</div>
<img src="close.soon" style="display:none;" onerror="(function(el){ setTimeout(function(){ $(el).parent().remove(); },5000 ); })(this);" /></div>';
    ...
    <div class="col-lg-5">
     <div class="user-info">
        <div id="table-header">Profile details</div><br>
            ...
            <p><i class="fas fa-city"></i> <?= htmlentities($user_details->city)?></p>
